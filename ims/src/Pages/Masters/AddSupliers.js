...
export default function AddSupliers() {
  ...
  const addSupliers = async () => {
    ...
    console.log(userId);
    let result = await fetch("http://localhost:5000/add-suppliers", {
      method: "post",
      body: JSON.stringify({
        name,
        code,
  ...
  return (
    <div className="add-product-container">
      <Box
        ...
        autoComplete="off"
      >
        <h1 className="add-product-heading"> Add-Suppliers :</h1>
        ...
        >
          {name && code && email && mobileno && gstno ? (
            ...
            <NavLink to="/add-suppliers" className="link">
              Submit
            </NavLink>
          )}
        </Button>
