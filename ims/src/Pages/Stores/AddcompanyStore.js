...
export default function AddcompanyStore() {
  ...
  //
  //Organization me select kerne pr company name ke value k liye
  ...
  const addCompany = async () => {
    ...
    console.log(userId);
    let result = await fetch("http://localhost:5000/add-companystore", {
      method: "post",
      body: JSON.stringify({
        organizationId,
        name,
  ...
  return (
    <div className="add-product-container">
      <Box
        ...
        autoComplete="off"
      >
        <h1 className="add-product-heading"> AddcompanyStore :</h1>
        <div className="add-product-textfield">
          ...
          <TextField
            ...
            label="CompanyStore Name:"
            placeholder="CompanyStore Name"
            multiline
            maxRows={4}
            type="text"
            value={name}
        ...
        >
          {name && code && email && mobileno && gstno ? (
            <NavLink to="/company-stores" className="link">
              Submit
            </NavLink>
          ) : (
            <NavLink to="/add-company-stores" className="link">
              Submit
            </NavLink>
          )}
        </Button>
