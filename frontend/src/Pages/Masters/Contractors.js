...
export default function Contractor() {
  ...
  const deleteContractor = async (id) => {
    let result = await fetch(`http://localhost:5000/contractor/${id}`, {
      method: "Delete",
    });

    if (result) {
      alert("Your Contractor list is deleted:");
      result = await result.json();
      getContractor();
    }
  };
    ...
    <div className="">
      <TableContainer component={Paper}>
        <div style={styles.container}>
          <h1 style={styles.heading}>Contractor List:</h1>
